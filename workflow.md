...
2.  **[ ] Commit 2: UI Upgrade** - Add visual "Power-up Countdown" timers/bars below the player.
...
7.  **[ ] Commit 7: Audio** - Add "Level Up" jingle and "Power-up Expire" warning sound.
